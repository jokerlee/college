#if !defined _AFX_CFILETREE_H__INCLUDED_
#define _AFX_CFILETREE_H__INCLUDED_
...
typedef struct Inode
{
	...
	Inode(CString FileName="", BOOL isDir=0, UINT FileSize=0, 
		BOOL HasChild=0, BOOL HasSibling=0, UINT Begin=0, UINT End=0)
	{
	...
	void Write(CFile * & ofp)
	{
		...
		ofp->Write((char*)&nEnd, sizeof(UINT));
	}
	// read from file
	void Read(CFile * & ifp)
	{
		...
		ifp->Read((char*)&nEnd, sizeof(UINT));
	}
